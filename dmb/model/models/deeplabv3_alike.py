...
class DeepLabV3Alike(_SimpleSegmentationModel):
    ...
    def __init__(self, in_channels: int, out_channels:int,backbone:Literal["regnet_y_400mf","resnet18","se_resnet18"]="regnet_y_400mf") -> None:
        ...
        if backbone == "resnet18":
            ...
            raise ValueError("backbone must be either resnet18 or regnet_y_400mf. Got: {}".format(backbone))
